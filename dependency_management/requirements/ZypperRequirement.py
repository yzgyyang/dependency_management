...
class ZypperRequirement(PlatformRequirement):
    """
    This class is a subclass of ``PlatformRequirement``. It specifies the proper
    type for ``Zypper`` packages and provide a function to check for the
    requirement.
    """

    REQUIREMENTS = {ExecutableRequirement('zypper')}
    ...
    def __init__(self, package, version=''):
        """
        Creates a new ``ZypperRequirement``, using the ``PlatformRequirement``
        constructor.
    ...
    def install_command(self):
        ...
        """
        result = ['zypper', '--non-interactive', 'install',
